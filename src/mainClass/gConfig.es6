...
export default class gConfig {
	...
	constructor(config:object = {}) {
		 ...
		 */
		this.bowerFolder = this.rootDir + (config.bowerFolder || 'bower_components') + this.DS;
		/**
		 ...
		 * @example './_DOCS/'
		 */
		this.docsFolder = this.rootDir + (config.docsFolder || '_DOCS') + this.DS;
		/**
		 * Default value :: '/'<br>
		 ...
		 * @example 'mainSite'
		 */
		this.site = config.site || (process.env.TAGGLISH_SITE || 'mainSite').toLowerCase();
		/**
		 * Default value :: {}<br>
